                    ...
                    <form class="form-horizontal" method="post" action="{{ url('customer/store') }}">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="number" class="form-control" name="age" placeholder="Enter a number">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" name="income" placeholder="Enter a number">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Spending Score</label>
                                <div class="col-sm-2">
                                    <input type="number" class="form-control" name="spending_score" placeholder="1 - 100">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Profession</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="profession" placeholder="Job Profession">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Work Experience</label>
                                <div class="col-sm-2">
                                    <input type="number" class="form-control" name="work_experience" placeholder="Enter a number">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Family Size</label>
                                <div class="col-sm-2">
                                    <input type="number" class="form-control" name="family_size" placeholder="Enter a number">
                                </div>
                            </div>
